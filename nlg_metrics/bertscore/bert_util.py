...
def collate_idf(arr, tokenizer, idf_dict, device='cuda:0'):
    ...
    """
    arr = [tokenizer.encode(a, add_special_tokens=True,
                            max_length=tokenizer.max_len) for a in arr]
...
def bert_score2(reference, generated):
    return score(reference, generated, lang='en', batch_size=128, verbose=True, model_type='bert-base-uncased')
